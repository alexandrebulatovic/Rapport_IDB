...
\newglossaryentry{sgbd}{
        ...
        plural={systèmes de gestion de bases de données},
        description={Abrégé \textit{SGBD}. Logiciel permettant de manipuler une base de données informatisée et relationnelles}}

\newacronym[plural={LDD},
        first={Langage de Définition des Données},
        firstplural={Langages de Définition des Données}]{ldd}{LDD}{
...
\newacronym[plural=LMD,
        first={Langage de définition des données},
        firstplural={Langages de définiton des données}]{lmd}{LMD}{Langage de Manipulation des Données, un sous-ensemble du \gls{sql} permettant d'effectuer les opérations \gls{crud} sur les données contenues dans les tables}

\newacronym[plural={SQL},
        first={Structured Query Language}]{sql}{SQL}{Structured Query Langage, un langage déclaratif et normé permettant d'utiliser les \gls{bddr}, largement inspiré par Codd en 1970 et devenu un standart aux Etats-Unis en 1984}

\newacronym[first={Create, Read, Update, Delete}]{crud}{CRUD}{Create, Read, Update, Delete sont les quatre opérations basiques à effectuer sur des enregistrements de données, respectivement : en ajouter des nouveaux, les lire, les mettre à jour et les effacer.}

\newglossaryentry{si}{
        name={système d'information},
        plural={systèmes d'informations},
        description={Le système d'information est un ensemble organisé de ressources qui permet de collecter, stocker, traiter et distribuer de l'information}}
